...
STAGING_DIR="${HOME}/frontend-app-dev"
SERVICE_NAME="frontend-app-dev"
SERVICE_DIR="${HOME}/.config/systemd/user"
NETWORK_NAME="geohod-net-dev"

echo "--- Starting Frontend Development Deployment ---"
...
echo "--- Frontend development deployment finished ---"